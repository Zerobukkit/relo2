...
agreeButton.addEventListener("click", () => {
  ...
  revealButton.addEventListener("click", () => {
    ...
    // Display the tix.png image
    const tixImage = document.createElement("img");
    tixImage.src = "tix.png";
    tixImage.alt = "Ticket Image";
    tixImage.style.position = "absolute";
    tixImage.style.top = "50%";
    tixImage.style.left = "50%";
    tixImage.style.transform = "translate(-50%, -50%)";
    tixImage.style.maxWidth = "80%";
    tixImage.style.maxHeight = "80%";
    tixImage.style.boxShadow = "0px 4px 10px rgba(0, 0, 0, 0.3)";
    document.body.appendChild(tixImage);
  });
});
